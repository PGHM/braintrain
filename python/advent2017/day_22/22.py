...
def burst(virus, infected_nodes, infection_count):
...
# Python's recursion limit and heavy memory usage with recursion hit us again
# and we have to do this iteratively
for i in range(0, bursts):
    virus, infected_nodes, infection_count = burst(
        virus, 
        infected_nodes,
        infection_count
    )
